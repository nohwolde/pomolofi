  ...
  return (
    ...
    >
      <motion.div
        ...
        className="glass-effect rounded-3xl p-8 max-w-[800px] w-full mx-4 text-center max-h-[80vh] overflow-y-auto"
      >
        <h2 className="text-2xl font-medium text-white/90 mb-8">Select Environment</h2>
